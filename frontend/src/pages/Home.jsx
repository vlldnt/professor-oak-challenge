    ...
    <div className="max-w-screen-xl mx-auto px-6 py-16 lg:px-8">
      ...
      <div className="mt-20 mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-4">{t("missionDescription1")}</p>
            <p className="text-gray-600 mb-6">{t("missionDescription2")}</p>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">{t("goalDescription")}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-20 grid md:grid-cols-3 gap-8">
        {features.map((feature, index) => (
          ...
          >
            <div
              className={`w-12 h-12 bg-gradient-to-r ${feature.color} rounded-lg flex items-center justify-center text-2xl mb-4`}
            >
              {feature.icon}
            </div>
          ...
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div className="text-3xl font-bold text-blue-600 mb-1">
                {stat.value}
                {stat.max !== "∞" && (
                  <span className="text-gray-400">/{stat.max}</span>
                )}
              </div>
              ...
              {stat.max !== "∞" && (
                <div className="mt-2 w-full bg-gray-200 rounded-full h-2">
                  <div
                    ...
                    style={{
                      width: `${
                        (parseInt(stat.value) / parseInt(stat.max)) * 100
                      }%`,
                    }}
                  ></div>
                </div>
